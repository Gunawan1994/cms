...
func (x *PaginationRequest) Reset() {
	*x = PaginationRequest{}
	mi := &file_global_meta_meta_proto_msgTypes[0]
...
func (*PaginationRequest) Descriptor() ([]byte, []int) {
	return file_global_meta_meta_proto_rawDescGZIP(), []int{0}
}
...
func (x *FilterRequest) Reset() {
	*x = FilterRequest{}
	mi := &file_global_meta_meta_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FilterRequest) Descriptor() ([]byte, []int) {
	return file_global_meta_meta_proto_rawDescGZIP(), []int{1}
}
...
func (x *PaginationResponse) Reset() {
	*x = PaginationResponse{}
	mi := &file_global_meta_meta_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PaginationResponse) Descriptor() ([]byte, []int) {
	return file_global_meta_meta_proto_rawDescGZIP(), []int{2}
}
...
func (x *Meta) Reset() {
	*x = Meta{}
	mi := &file_global_meta_meta_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Meta) Descriptor() ([]byte, []int) {
	return file_global_meta_meta_proto_rawDescGZIP(), []int{3}
}
...
func (x *ResponseJson) Reset() {
	*x = ResponseJson{}
	mi := &file_global_meta_meta_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ResponseJson) Descriptor() ([]byte, []int) {
	return file_global_meta_meta_proto_rawDescGZIP(), []int{4}
}
...
var File_global_meta_meta_proto protoreflect.FileDescriptor

const file_global_meta_meta_proto_rawDesc = "" +
	"\n" +
	"\x16global/meta/meta.proto\x1a\x19google/protobuf/any.proto\"A\n" +
...
var (
	...
	file_global_meta_meta_proto_rawDescData []byte
)

func file_global_meta_meta_proto_rawDescGZIP() []byte {
	file_global_meta_meta_proto_rawDescOnce.Do(func() {
		file_global_meta_meta_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_global_meta_meta_proto_rawDesc), len(file_global_meta_meta_proto_rawDesc)))
	})
	return file_global_meta_meta_proto_rawDescData
}

var file_global_meta_meta_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_global_meta_meta_proto_goTypes = []any{
...
var file_global_meta_meta_proto_depIdxs = []int32{
...
func init() { file_global_meta_meta_proto_init() }
func file_global_meta_meta_proto_init() {
	if File_global_meta_meta_proto != nil {
		return
	}
	file_global_meta_meta_proto_msgTypes[3].OneofWrappers = []any{}
	file_global_meta_meta_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_global_meta_meta_proto_rawDesc), len(file_global_meta_meta_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_global_meta_meta_proto_goTypes,
		DependencyIndexes: file_global_meta_meta_proto_depIdxs,
		MessageInfos:      file_global_meta_meta_proto_msgTypes,
	}.Build()
	File_global_meta_meta_proto = out.File
	file_global_meta_meta_proto_goTypes = nil
	file_global_meta_meta_proto_depIdxs = nil
}
